...
find_library(CUDNN_LIBRARY NAMES ${CUDNN_LIB_NAME}
    PATHS ${CUDNN_ROOT} $ENV{CUDNN_ROOT} ${CUDNN_INCLUDE}/../lib64 ${__libpath_hist} ${__libpath_hist}/../lib
    DOC "Path to cuDNN library.")

if(CUDNN_INCLUDE)
        message(STATUS "cuDNN include found.")
endif()
if(CUDNN_LIBRARY)
        message(STATUS "cuDNN library found.")
endif()
